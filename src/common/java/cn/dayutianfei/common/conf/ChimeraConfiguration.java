...
import iie.mdss.server.util.ClassUtil;
import iie.mdss.server.util.PropertyUtil;
...
public class ChimeraConfiguration implements Serializable {

  private final static Logger LOG = Logger.getLogger(ChimeraConfiguration.class);
  private static final long serialVersionUID = 1L;
  protected Properties _properties;
  private final String _resourcePath;

  public ChimeraConfiguration(final String path) {
    _properties = PropertyUtil.loadProperties(path);
    _resourcePath = PropertyUtil.getPropertiesFilePath(path);
  }

  public ChimeraConfiguration(File file) {
    _properties = PropertyUtil.loadProperties(file);
    _resourcePath = file.getAbsolutePath();
  }

  public ChimeraConfiguration(Properties properties, String filePath) {
